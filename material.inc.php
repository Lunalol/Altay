...
//
		...
		6 => ['VP' => 0, 'title' => clienttranslate('Village'), clienttranslate('Collect to build ${settlement}'), null, null],
		7 => ['VP' => 0, 'title' => clienttranslate('Village'), clienttranslate('Collect to build ${settlement}'), null, null],
...
//
		...
		4 => ['VP' => 0, 'title' => clienttranslate('Hunter'), '${food}', null, null],
		5 => ['VP' => 0, 'title' => clienttranslate('Hunter'), '${food}', null, null],
		6 => ['VP' => 0, 'title' => clienttranslate('Loremaster'), '${culture}', clienttranslate('Store ${culture}'), null],
		7 => ['VP' => 0, 'title' => clienttranslate('Loremaster'), '${culture}', clienttranslate('Store ${culture}'), null],
		8 => ['VP' => 0, 'title' => clienttranslate('Village'), clienttranslate('Collect to build ${settlement}'), null, null],
		9 => ['VP' => 0, 'title' => clienttranslate('Warrior'), '${attack}', '${defense}', null],
		10 => ['VP' => 0, 'title' => clienttranslate('Warrior'), '${attack}', '${defense}', null],
	],
//
...
//
		...
		2 => ['VP' => 0, 'title' => clienttranslate('Hunter'), '${food}', null, null],
		3 => ['VP' => 0, 'title' => clienttranslate('Hunter'), '${food}', null, null],
		4 => ['VP' => 0, 'title' => clienttranslate('Shaman'), '${culture}', clienttranslate('Consume a [conquest-marker] to produce [any-resource}'), null],
		5 => ['VP' => 0, 'title' => clienttranslate('Village'), clienttranslate('Collect to build ${settlement}'), null, null],
		6 => ['VP' => 0, 'title' => clienttranslate('Village'), clienttranslate('Collect to build ${settlement}'), null, null],
...
//
		...
		7 => ['VP' => 0, 'title' => clienttranslate('Spellweaver'), '${culture}', clienttranslate('Store [any-resource}'), null],
		8 => ['VP' => 0, 'title' => clienttranslate('Village'), clienttranslate('Collect to build ${settlement}'), null, null],
		9 => ['VP' => 0, 'title' => clienttranslate('Warrior'), '${attack}', '${defense}', null],
		10 => ['VP' => 0, 'title' => clienttranslate('Warrior'), '${attack}', '${defense}', null],
	],
...
//
	41 => ['VP' => 1, 'title' => clienttranslate('Merchant'), clienttranslate('Store up to [any-resource}'), null, null],
	42 => ['VP' => 0, 'title' => clienttranslate('Merchant'), clienttranslate('Store up to [any-resource}'), null, null],
	43 => ['VP' => 0, 'title' => clienttranslate('Merchant'), clienttranslate('Store up to [any-resource}'), null, null],
	44 => ['VP' => 0, 'title' => clienttranslate('Merchant'), clienttranslate('Store up to [any-resource}'), null, null],
	45 => ['VP' => 0, 'title' => clienttranslate('Merchant'), clienttranslate('Store up to [any-resource}'), null, null],
	46 => ['VP' => 0, 'title' => clienttranslate('Merchant'), clienttranslate('Store up to [any-resource}'), null, null],
	47 => ['VP' => 0, 'title' => clienttranslate('Merchant'), clienttranslate('Store up to [any-resource}'), null, null],
	48 => ['VP' => 0, 'title' => clienttranslate('Merchant'), clienttranslate('Store up to [any-resource}'), null, null],
//
...
//
	57 => ['VP' => 1, 'title' => clienttranslate('Town'), clienttranslate('Collect to build ${settlement}'), null, null],
	58 => ['VP' => 0, 'title' => clienttranslate('Town'), clienttranslate('Collect to build ${settlement}'), null, null],
	59 => ['VP' => 0, 'title' => clienttranslate('Town'), clienttranslate('Collect to build ${settlement}'), null, null],
	60 => ['VP' => 0, 'title' => clienttranslate('Town'), clienttranslate('Collect to build ${settlement}'), null, null],
	61 => ['VP' => 0, 'title' => clienttranslate('Town'), clienttranslate('Collect to build ${settlement}'), null, null],
	62 => ['VP' => 0, 'title' => clienttranslate('Town'), clienttranslate('Collect to build ${settlement}'), null, null],
	63 => ['VP' => 0, 'title' => clienttranslate('Town'), clienttranslate('Collect to build ${settlement}'), null, null],
	64 => ['VP' => 0, 'title' => clienttranslate('Town'), clienttranslate('Collect to build ${settlement}'), null, null],
//
...
//
	81 => ['VP' => 2, 'title' => clienttranslate('City'), clienttranslate('Collect to build ${settlement] ${settlement}'), null, null],
	82 => ['VP' => 1, 'title' => clienttranslate('City'), clienttranslate('Collect to build ${settlement] ${settlement}'), null, null],
	83 => ['VP' => 0, 'title' => clienttranslate('City'), clienttranslate('Collect to build ${settlement] ${settlement}'), null, null],
	84 => ['VP' => 0, 'title' => clienttranslate('City'), clienttranslate('Collect to build ${settlement] ${settlement}'), null, null],
	85 => ['VP' => 0, 'title' => clienttranslate('City'), clienttranslate('Collect to build ${settlement] ${settlement}'), null, null],
	86 => ['VP' => 0, 'title' => clienttranslate('City'), clienttranslate('Collect to build ${settlement] ${settlement}'), null, null],
	87 => ['VP' => 0, 'title' => clienttranslate('City'), clienttranslate('Collect to build ${settlement] ${settlement}'), null, null],
	88 => ['VP' => 0, 'title' => clienttranslate('City'), clienttranslate('Collect to build ${settlement] ${settlement}'), null, null],
];
